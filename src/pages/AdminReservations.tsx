        ...
        <div className="space-y-6">
          ...
          {filteredReservations.map((res) => (
            ...
            <motion.div
              ...
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
              className="bg-card rounded-2xl border border-border p-6 shadow-lg backdrop-blur-md hover:border-primary/40 transition"
            >
              ...
              <div className="mt-4 flex justify-between items-center">
                ...
                {res.specialRequest && (
                  ...
                  <button
                    onClick={() =>
                      setExpandedId(res.reservationId)
                    }
      ...
      {expandedId && (
        ...
        >
          ...
          <motion.div
            ...
            className="bg-card rounded-2xl p-6 max-w-md w-full border border-border shadow-xl"
          >
