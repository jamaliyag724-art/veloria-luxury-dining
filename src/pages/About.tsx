            ...
            <div className="section-container grid lg:grid-cols-2 gap-12 items-center">
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">
                  ...
                  Chef Alessandro blends tradition with innovation.
                </p>
                <div className="flex gap-3 flex-wrap">
                  {["Michelin Trained", "James Beard Nominee", "Le Cordon Bleu"].map(
                    (b) => (
                      <span
                        key={b}
              ...
              <motion.img
                ...
                whileInView={{ opacity: 1, x: 0 }}
                viewport={{ once: true }}
                className="w-full h-[500px] object-cover rounded-2xl shadow-lift"
              />
            </div>
          </section>
        </main>
