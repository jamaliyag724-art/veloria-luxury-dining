...
export const menuItems: MenuItem[] = [
  ...
  // BEVERAGES (15 items)
  { id: 'w1', name: 'Dom Pérignon 2012', description: 'Champagne, France - Elegant with citrus and brioche notes', price: 420, image: 'https://images.unsplash.com/photo-1547595628-c61a29f496f0?w=400', category: 'beverages', featured: true },
  { id: 'w2', name: 'Château Margaux 2015', description: 'Bordeaux, France - Full-bodied with cassis and cedar', price: 850, image: 'https://images.unsplash.com/photo-1506377247377-2a5b3b417ebb?w=400', category: 'beverages' },
  { id: 'w3', name: 'Opus One 2018', description: 'Napa Valley, USA - Rich blend of Cabernet and Merlot', price: 550, image: 'https://images.unsplash.com/photo-1510812431401-41d2bd2722f3?w=400', category: 'beverages' },
  { id: 'w4', name: 'Cloudy Bay Sauvignon', description: 'Marlborough, NZ - Crisp with tropical fruit notes', price: 68, image: 'https://images.unsplash.com/photo-1558001373-7b93ee48ffa0?w=400', category: 'beverages' },
  { id: 'w5', name: 'Amarone della Valpolicella', description: 'Veneto, Italy - Intense with dried fruit complexity', price: 145, image: 'https://images.unsplash.com/photo-1474722883778-792e7990302f?w=400', category: 'beverages' },
  { id: 'w6', name: 'Classic Martini', description: 'Grey Goose vodka or Tanqueray gin with dry vermouth', price: 22, image: 'https://images.unsplash.com/photo-1575023782549-62ca0d244b39?w=400', category: 'beverages' },
  { id: 'w7', name: 'Old Fashioned', description: 'Woodford Reserve bourbon with bitters and orange', price: 24, image: 'https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=400', category: 'beverages' },
  { id: 'w8', name: 'Negroni', description: 'Campari, gin, and sweet vermouth with orange twist', price: 20, image: 'https://images.unsplash.com/photo-1551538827-9c037cb4f32a?w=400', category: 'beverages' },
  { id: 'w9', name: 'Whiskey Sour', description: 'Bulleit bourbon with lemon and egg white foam', price: 18, image: 'https://images.unsplash.com/photo-1514362545857-3bc16c4c7d1b?w=400', category: 'beverages' },
  { id: 'w10', name: 'Espresso', description: 'Double shot of Italian espresso', price: 6, image: 'https://images.unsplash.com/photo-1510707577719-ae7c14805e3a?w=400', category: 'beverages' },
  { id: 'w11', name: 'Cappuccino', description: 'Espresso with steamed milk and foam', price: 8, image: 'https://images.unsplash.com/photo-1572442388796-11668a67e53d?w=400', category: 'beverages' },
  { id: 'w12', name: 'Artisan Tea Selection', description: 'Premium loose-leaf teas from around the world', price: 10, image: 'https://images.unsplash.com/photo-1556679343-c7306c1976bc?w=400', category: 'beverages' },
  { id: 'w13', name: 'Fresh Juice', description: 'Orange, grapefruit, or green juice blend', price: 12, image: 'https://images.unsplash.com/photo-1600271886742-f049cd451bba?w=400', category: 'beverages' },
  { id: 'w14', name: 'Sparkling Water', description: 'San Pellegrino or Acqua Panna', price: 8, image: 'https://images.unsplash.com/photo-1523362628745-0c100150b504?w=400', category: 'beverages' },
  { id: 'w15', name: 'Mocktail Selection', description: 'Virgin mojito, berry fizz, or ginger spritz', price: 14, image: 'https://images.unsplash.com/photo-1536935338788-846bb9981813?w=400', category: 'beverages' },
];
